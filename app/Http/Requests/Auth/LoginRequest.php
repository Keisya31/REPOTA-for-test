...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        $this->ensureIsNotRateLimited();
         ...
         // Ambil user dengan relasi mahasiswa dan admin (termasuk yang soft delete)
        ...
        // Cek apakah mahasiswa sudah soft delete
        if ($user->mahasiswa && $user->mahasiswa->deleted_at !== null) {
            throw ValidationException::withMessages([
                'username' => 'Akun ini dinonaktfikan atau sudah dihapus.',
            ]);
        }
