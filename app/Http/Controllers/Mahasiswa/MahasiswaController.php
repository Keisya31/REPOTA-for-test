...
class MahasiswaController extends Controller
{
    ...
    {
        $mhs = Auth::user()->mahasiswa->mhs_nama;
        $skripsi = Auth::user()->mahasiswa->skripsi;
        return view("mahasiswa.mhs-dashboard", compact('mhs', 'skripsi'));
    }
    ...
    public function create()
    {
        ...
        return view('mahasiswa.mhs-tambah-skripsi', compact('mhs'));
    }
     ...
     public function store(Request $request)
    {
        ...
        try{
            ...
            [
                'file_skripsi.mimes' => 'File harus berformat PDF, DOC, atau DOCX.',
                'file_skripsi.max' => 'Ukuran file maksimal 15MB.',
            ]);
        ...
        try{
            ...
            $skripsi->nim_mhs = $mahasiswa->nim;
            $skripsi->nama_mhs = $mahasiswa->mhs_nama;
    ...
    public function edit($id)
    {
        ...
        $mhs = Auth::user()->mahasiswa;
        return view('mahasiswa.mhs-edit-skripsi', compact('skripsi', 'mhs'));
    }
