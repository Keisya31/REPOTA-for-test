<x-app-layout>
     <button onclick="history.back()" class="text-sm font-medium text-gray-600 hover:text-black transition">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-1 font-medium text-gray-900 dark:text-white bg-white pb-3">
                            @if ($skripsi->path_hlm_depan)
                                ...
                                <a href="{{ route('skripsi.download-hlm-depan', $skripsi->id) }}" class="text-blue-500 hover:underline ml-3">Download File</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-1 font-medium text-gray-900 dark:text-white bg-white pb-3">
                            @if ($skripsi->path_bab1)
                                ...
                                <a href="{{ route('skripsi.download-bab1', $skripsi->id) }}" class="text-blue-500 hover:underline ml-3">Download File</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
